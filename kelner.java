...
public class kelner {
    ...
    private static final int SIMULATION_DURATION_SECONDS = 20;
    private static volatile boolean running = true;
    private static final Semaphore waiter = new Semaphore(N - 1, true);
    private static final Semaphore[] forks = new Semaphore[N];
    private static final String[] philosopherStates = new String[N];
    private static final long[] philosopherWaitingTimes = new long[N];
    ...
    static class Philosopher extends Thread {
        ...
        private void eat() throws InterruptedException {
            ...
            synchronized (PRINT_LOCK) {
                ...
                philosopherWaitingTimes[id] = waitingTime;
                mealsEaten[id]++;
        ...
        private void setState(String state, long waitingTime) {
            synchronized (PRINT_LOCK) {
